...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder>{
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, int position) {
        ...
        //if the note is selected, show the pinned icon
    ...
    //pick a random color every time, and assign it to the note
    private int getRandomColor(){
        ...
        //return the color code, not just an integer
    ...
    //After the user searching, replace the original list with all notes with the filtered ones
